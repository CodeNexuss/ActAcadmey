...
class OptionSeeder extends Seeder
{
    ...
    public function run()
    {
        $options = array(
            ...
            array('id' => '4','option_key' => 'site_name','option_value' => 'Site name'),
            array('id' => '5','option_key' => 'site_title','option_value' => 'Site title'),
            array('id' => '6','option_key' => 'email_address','option_value' => 'example@example.com'),
            ...
            array('id' => '12','option_key' => 'paypal_receiver_email','option_value' => 'PayPal receiver email'),
            array('id' => '13','option_key' => 'stripe_test_secret_key','option_value' => 'Stripe test secret key'),
            array('id' => '14','option_key' => 'stripe_test_publishable_key','option_value' => 'stripe test publishable key'),
            ...
            array('id' => '24','option_key' => 'fb_app_id','option_value' => 'Facebook App Id'),
            array('id' => '25','option_key' => 'fb_app_secret','option_value' => 'Facebook App Secret'),
            array('id' => '26','option_key' => 'google_client_id','option_value' => 'Google Client Id'),
            array('id' => '27','option_key' => 'google_client_secret','option_value' => 'Google Client Secret'),
            ...
            array('id' => '43','option_key' => 'site_url','option_value' => 'Site URL'),
            ...
            array('id' => '48','option_key' => 'terms_of_use_page','option_value' => NULL),
            array('id' => '49','option_key' => 'privacy_policy_page','option_value' => NULL),
            array('id' => '50','option_key' => 'about_us_page','option_value' => NULL),
            ...
            array('id' => '52','option_key' => 'social_login','option_value' => 'json_encode_value_{"facebook":{"enable":"1","app_id":"Facebook App Id","app_secret":"Facebook App Secret"},"google":{"enable":"1","client_id":"Google Client Id","client_secret":"Google Client Secret"},"twitter":{"enable":"1","consumer_key":"Twitter Consumer Key","consumer_secret":"Twitter Consumer Secret"},"linkedin":{"enable":"1","client_id":"Linkedin Client Id","client_secret":"Linkedin Client Secret"}}'),
            ...
            array('id' => '58','option_key' => 'copyright_name','option_value' => 'Site name'),
            array('id' => '59','option_key' => 'about_us_content','option_value' => 'Our platform that connect Teachers with Students globally. Teachers create high quality course and present them in super easy way.'),
            array('id' => '60','option_key' => 'site_address','option_value' => "Your Site Address"),
            array('id' => '61','option_key' => 'site_phone_number','option_value' => '0123456789'),
            array('id' => '62','option_key' => 'site_email','option_value' => 'example@example.com'),
            array('id' => '63','option_key' => 'site_favicon','option_value' => '246'),
            array('id' => '64','option_key' => 'site_email_logo','option_value' => '246'),
            array('id' => '42','option_key' => 'enable_telebirr','option_value' => '1'),
        );
